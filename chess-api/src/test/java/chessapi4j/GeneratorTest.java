...
public class GeneratorTest {
	...
	void numberOfPositions1() {
		...
		logger.debug("GeneratorTest-Position%d time[ms]: %d", 1, d2.toInstant().toEpochMilli() - d1.toInstant().toEpochMilli());
	}
	...
	void numberOfPositions2() {
		...
		OffsetDateTime d2 = OffsetDateTime.now();
		logger.debug("GeneratorTest-Position%d time[ms]: %d", 2, d2.toInstant().toEpochMilli() - d1.toInstant().toEpochMilli());
	}
	...
	void numberOfPositions3() {
		...
		OffsetDateTime d2 = OffsetDateTime.now();
		logger.debug("GeneratorTest-Position%d time[ms]: %d", 3, d2.toInstant().toEpochMilli() - d1.toInstant().toEpochMilli());
	}
	...
	void numberOfPositions4() {
		...
		OffsetDateTime d2 = OffsetDateTime.now();
		logger.debug("GeneratorTest-Position%d time[ms]: %d", 4, d2.toInstant().toEpochMilli() - d1.toInstant().toEpochMilli());
	}
	...
	void numberOfPositions5() {
		...
		OffsetDateTime d2 = OffsetDateTime.now();
		logger.debug("GeneratorTest-Position%d time[ms]: %d", 5, d2.toInstant().toEpochMilli() - d1.toInstant().toEpochMilli());
	}
	...
	void numberOfPositions6() {
		...
		OffsetDateTime d2 = OffsetDateTime.now();
		logger.debug("GeneratorTest-Position%d time[ms]: %d", 6, d2.toInstant().toEpochMilli() - d1.toInstant().toEpochMilli());
	}
